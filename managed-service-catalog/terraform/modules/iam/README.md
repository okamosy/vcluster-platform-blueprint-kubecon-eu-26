...
| <a name="input_sa_key_ttl_days"></a> [sa\_key\_ttl\_days](#input\_sa\_key\_ttl\_days) | Service account key TTL in days. If null, TTL and key rotation are deactivated. | `number` | `null` | no |
